...
/**
 * <b> Responsabilità : </b> Definisce un giocatore di tipo umano con le caratteristiche di
...
public class HumanPlayer implements Player{
	 ...
	 * Tipo di giocatore
	 */
	private final TypePlayer 		TYPE_OF_PLAYER = TypePlayer.PLAYER;
	...
	public HumanPlayer(String name,TypeGamePlayer type) {
		this.name = name;
